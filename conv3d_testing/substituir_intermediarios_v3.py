...
class FrameInterpolationModel(nn.Module):
    def __init__(self):
        ...
        self.encoder = nn.Sequential(
            nn.Conv3d(2, 64, kernel_size=(2, 4, 4), padding=(1, 1, 1), stride=(1, 2, 2)),  # Stride maior apenas aqui
            nn.PReLU(),
            nn.Conv3d(64, 128, kernel_size=(2, 3, 3), padding=(1, 1, 1), stride=(1, 2, 2)),  # Stride 1 nas demais
            nn.PReLU(),
            nn.Conv3d(128, 256, kernel_size=(2, 2, 2), padding=(1, 1, 1), stride=(1, 1, 1)),  # Stride 1 aqui também
            nn.PReLU(),
        )
        
        self.decoder = nn.Sequential(
            nn.ConvTranspose3d(256, 128, kernel_size=(2, 2, 2), padding=(1, 1, 1), stride=(1, 2, 2), output_padding=(0, 1, 1)),
            nn.PReLU(),
            nn.ConvTranspose3d(128, 64, kernel_size=(2, 3, 3), padding=(1, 1, 1), stride=(1, 2, 2), output_padding=(0, 1, 1)),
            nn.PReLU(),
            nn.Conv3d(64, 3, kernel_size=(2, 4, 4), padding=(1, 1, 1), stride=(1, 1, 1)),
            nn.PReLU(),
        )
...
if __name__ == "__main__":
    video_path = 'videos_all\\thelastofus.mp4'
    output_path = 'videos_interloper\\thelastofus_interlope_v3.mp4'
