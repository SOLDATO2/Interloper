...
def main(video_path, output_path, model_path="bkp_inter\\frame_interpolation_model.pth"):
    ...
    frames, fps = extract_frames(video_path, max_seconds=10)
    interpolate_frames(model, frames, output_path, fps, device)
    print(f'Vídeo interpolado salvo em {output_path}')

if __name__ == "__main__":
    video_path = 'bkp_inter\\darkurge_intro.mp4'
    output_path = 'bkp_inter\\darkurge_intro_interlope.mp4'
