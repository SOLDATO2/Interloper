...
class FrameInterpolationModel(nn.Module):
    def __init__(self):
        ...
        self.encoder = nn.Sequential(
            ...
            nn.PReLU(),
            nn.Conv2d(256, 512, kernel_size=3, padding=1, stride=2),  # Reduz mais uma vez pela metade
            nn.PReLU(),
        )
        
        self.decoder = nn.Sequential(
            nn.ConvTranspose2d(512, 256, kernel_size=3, padding=1, stride=2, output_padding=1),  # Aumenta a resolução
            nn.PReLU(),
...
def main(video_path, output_path, model_path="frame_interpolation_model_v2.pth"):
...
if __name__ == "__main__":
    ...
    output_path = 'test_video2_v2.mp4'
