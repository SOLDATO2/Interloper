...
class FrameInterpolationModel(nn.Module):
    def __init__(self):
        ...
        # Arquitetura utilizada no código de treinamento com perceptual loss
        # Ajustada conforme o código de treinamento anterior
...
def interpolate_frames(model, frames, output_path, fps, device):
    ...
    for i in range(0, len(frames) - 2, 2):
        ...
        with torch.no_grad():
            with autocast(device_type=str(device)):
                ...
                # Ajustar o tamanho para corresponder ao frame original
    ...
    print("Tempo de inferência:", counter2 - counter1, "segundos")
...
if __name__ == "__main__":
    ...
    output_path = 'testes_videos\\thelastofus_v2_4_GEN7_perceptual.mp4'
